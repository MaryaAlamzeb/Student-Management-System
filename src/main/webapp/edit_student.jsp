...
<body class="bg-light">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card">
					...
					<div class="card-body">
						...
						// First, get the instance of the DatabaseManager
    ...
    <input type="date" class="form-control" name="dob" value="<%= s.getDob().format(java.time.format.DateTimeFormatter.ISO_LOCAL_DATE) %>">
</div>
